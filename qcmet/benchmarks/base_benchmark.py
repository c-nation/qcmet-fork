...
class BaseBenchmark(ABC):
    ...
    def experiment_data(self, circuits: List[QuantumCircuit] | list[dict[str, Any]]):
        ...
        Args:
            circuits (List[QuantumCircuit] | list[dict[str, Any]]): The list of
    ...
    def _circs_to_df(self, circs_with_metadata: List[Dict[str, Any]]) -> DataFrame:
    ...
    def load_circuit_measurements(
        ...
        """
        if self._experiment_data is None:
            raise ValueError("Experiment data not yet generated")
